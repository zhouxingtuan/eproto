...
namespace test
{
    ...
    {
        public class inner : public Proto
        {
            public int t1;
            public std::string t2;
            ...
            virtual public Proto* Create() { return new inner(); }
        }
        public int a;
        public long long int b;
        public float c;
        public double d;
        public std::string e;
        public std::vector<char> f;
        public inner g;
        public std::unordered_map<int, std::string> h;
        public std::vector<int> i;
        public std::vector<inner> j;
        public std::unordered_map<std::string, inner> k;
        public std::unordered_map<std::string, std::vector<char>> l;
        virtual public void Encode(Writer& wb)
        {
            wb.pack_array(wb, 12);
            wb.pack_int(this.a);
        ...
        virtual public Proto* Create() { return new request(); }
    }
    class empty : public Proto
    {
        ...
        virtual public Proto* Create() { return new empty(); }
    }
    class response : public Proto
    {
        public int error;
        public std::vector<char> buffer;
        virtual public void Encode(Writer& wb)
        {
            wb.pack_array(wb, 2);
        ...
        virtual public Proto* Create() { return new response(); }
    }
