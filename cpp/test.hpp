...
namespace test
{
    ...
    public:
        ...
        static std::string ClassName() { return "test::empty"; }
    };
    ...
    public:
        ...
        public:
            ...
            static std::string ClassName() { return "test::request::inner"; }
        };
        int a;
        long long int b;
        float c;
        ...
        static std::string ClassName() { return "test::request"; }
    };
    ...
    public:
        ...
        static std::string ClassName() { return "test::response"; }
    };
